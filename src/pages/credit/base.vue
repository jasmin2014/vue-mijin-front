  ...
  <div class="content">
    ...
    <div class="credit-content">
      ...
      <div class="main-content credit-form">
        <h3>基本信息</h3>
        <div class="credit-form-inner credit-form-base">
          <el-form ref="creditForm" :model="creditForm" label-width="170px" :rules="creditFormRules">
            ...
            <el-form-item label="婚姻状况：" class="credit-custom-select" prop="marital">
              <div class="width450">
                <mj-select v-model="creditForm.marital" :kind="$enum.MARITAL" :group="$enum.MARITAL" :clearable="true"></mj-select>
              </div>
            </el-form-item>
            <div class="flex-start credit-relation">
              ...
              <el-form-item label="关系：" class="flex-start relation-type" label-width="130" prop="familyRelationship">
                <mj-select v-model="creditForm.familyRelationship" :kind="$enum.RELATIONSHIP" :group="$enum.FAMILY_RELATIONSHIP" :clearable="true"></mj-select>
              </el-form-item>
              <el-form-item label="手机号码：" class="flex-start relation-phone" label-width="150" prop="familyMobile">
                <mj-input v-model="creditForm.familyMobile"></mj-input>
              </el-form-item>
            </div>
            <div class="flex-start credit-relation">
              <el-form-item label="其它联系人姓名：" class="relation-name" prop="otherName">
                <mj-input v-model="creditForm.otherName"></mj-input>
              </el-form-item>
              <el-form-item label="关系：" class="flex-start relation-type" label-width="130" prop="otherRelationship">
                <mj-select v-model="creditForm.otherRelationship" :kind="$enum.RELATIONSHIP" :group="$enum.CONTACT_RELATIONSHIP" :clearable="true"></mj-select>
              </el-form-item>
              <el-form-item label="手机号码：" class="flex-start relation-phone" label-width="150" prop="otherMobile">
                <mj-input v-model="creditForm.otherMobile"></mj-input>
              </el-form-item>
            </div>
            <div class="flex-start credit-branch-bank" v-if="this.productType=='QYT_LOANS'">
              <el-form-item label="实际经营地址：" prop="provinceCode" class="mr10">
                <mj-select v-model="creditForm.provinceCode" :region="'86'" ref="changeProvince" @kv-change="handleChangeProvince" :clearable="true"></mj-select>
              </el-form-item>
              <el-form-item prop="cityCode" label-width="20" class="mr10">
                <mj-select v-model="creditForm.cityCode" :region="creditForm.provinceCode" @kv-change="handleChangeCity" :clearable="true"></mj-select>
              </el-form-item>
            ...
            <el-form-item label="实际经营地址：" prop="actualManagementAddress" v-if="this.productType=='DST_LOANS'">
              <div class="width450">
                <mj-input v-model="creditForm.actualManagementAddress"></mj-input>
              </div>
            </el-form-item>
            <el-form-item label="店铺（企业）名称：" prop="shopName">
              <div class="width450">
            ...
            <el-form-item label="所属行业：" class="credit-custom-select" prop="industry">
              <div class="width450">
                <mj-select v-model="creditForm.industry" :kind="$enum.INDUSTRY" :group="$enum.INDUSTRY" :clearable="true"></mj-select>
              </div>
            </el-form-item>
            <el-form-item label="年收入（万元）：" class="credit-custom-select" prop="annualSalary">
              <div class="width450">
                <mj-select v-model="creditForm.annualSalary" :kind="$enum.ANNUAL_SALARY" :group="$enum.ANNUAL_SALARY" :clearable="true"></mj-select>
              </div>
            </el-form-item>
            <el-form-item label="借款用途：" class="credit-custom-select" prop="loanPurpose">
              <div class="width450">
                <mj-select v-model="creditForm.loanPurpose" :kind="$enum.USAGE_LOAN" :group="$enum.LOAN" :clearable="true"></mj-select>
              </div>
            </el-form-item>
            <el-form-item label="还款来源：" class="credit-custom-select" prop="payment">
              <div class="width450">
                <mj-select v-model="creditForm.payment" :kind="$enum.PAYMENT" :group="$enum.PAYMENT" :clearable="true"></mj-select>
              </div>
            </el-form-item>
            <div class="step-btns">
  ...
  export default {
    ...
    data() {
      let familyMobileRule = (rule, value, callback) => {
        if (!this.$valid.mobile.test(value)) {
      ...
      getRelationList() {
        api.getRelationList().then(res => {
          if (res.data.code === 200) {
            ...
            this.creditForm.familyName = _relationDTO && _relationDTO.realName ? _relationDTO.realName : '';
            this.creditForm.familyRelationship = _relationDTO && _relationDTO.relKind ? _relationDTO.relKind : ''
            this.creditForm.familyMobile = _relationDTO && _relationDTO.mobile ? _relationDTO.mobile : ''
            this.creditForm.otherName = _friendDTO && _friendDTO.realName ? _friendDTO.realName : '';
            this.creditForm.otherRelationship = _friendDTO && _friendDTO.relKind ? _friendDTO.relKind : ''
            this.creditForm.otherMobile = _friendDTO && _friendDTO.mobile ? _friendDTO.mobile : ''
          }
        })
      },
      // 开户下一步
