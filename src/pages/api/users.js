...
export const getAssetFlowRecords = (params) => {
  return https.mijin.get('v1/account/center/_page-for-account-flow', {params})
}
...
export const putChangeGuarantee = (creditId,params) => {
  return https.mijin.put(`v1/asset/guarantee-application/update?creditId=${creditId}`,params)
}
...
export const putGuaranteeApplication = (params) => {
  return https.mijin.put(`v1/asset/guarantee-application/_signing?applicationId=${params.applicationId}&status=${params.status}`)
}

/**========我的账户-担保记录-拒绝签约=======**/
export const putCancelSigning = (params) => {
  return https.mijin.put(`v1/asset/guarantee-application/_cancel?applicationId=${params.applicationId}&status=${params.status}`)
}
...
export const getGuaranteeMessageCode = (params) => {
  return https.mijin.get(`/v1/asset/guarantee-application/obtain-code?applicationId=${params.applicationId}`)
}

/**========我的账户--担保记录-核对验证码============**/
export const ValidateGuaranteeMessageCode = (code) => {
  return https.mijin.get(`/v1/asset/guarantee-application/verify-code?code=${code}`)
}
...
export const postWithDrawForFund = (params) => {
  return https.mijin.post('v1/account/center/_withdraw-for-fund-center',params)
}
...
export const getLoanApplicationList = (params) => {
  return https.mijin.get('v1/asset/loan-application/_page-for-loan-application', {params})
}
...
export const getContractMessageCode = (params) => {
  return https.mijin.get(`/v1/asset/loan-application/obtain-code?applicationId=${params.applicationId}`)
}
...
export const putLoanApplicationSiging = (params) => {
  return https.mijin.put(`v1/asset/loan-application/_signing?applicationId=${params.applicationId}&status=${params.status}`)
}

/**========我的账户-借款记录-拒绝签约============**/
export const putCancelLoanApplicationSiging = (params) => {
  return https.mijin.put(`v1/asset/loan-application/_cancel?applicationId=${params.applicationId}&status=${params.status}`)
}
